# Alizé — Resolved Decisions & TODO

> Auto-generated from debate/research pulse.
...
### Immediate
- [ ] Buy domain
- [ ] Define first pilot client profile
- [ ] Build MCP server demonstration
- [ ] Update BRIEF.md with competitor analysis (add Microsoft/HubSpot as primary threats)
- [ ] Create landing page (domain needed first)

### This Week
- [ ] Deep research: Agentova product analysis
- [ ] Deep research: French PME AI readiness
- [ ] Pricing benchmark study
- [ ] Technical architecture for multi-tenant agents

### Open Questions
- Should Alizé compete directly with Agentova or find a niche angle?
