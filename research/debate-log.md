# Alizé Research — Debate Log

Central log of all debate outcomes across research pulses.

---

## Pulse 1 (2026-03-30 AM)

| Agent | Topic | Key Findings |
|-------|-------|-------------|
| Pricing Strategy | Per-agent vs workflow-tier | Workflow-tier wins; €490 diagnostic kills funnel |
| Competitive Strategy | Agentova vs platform giants | Microsoft/HubSpot more dangerous than Agentova |
| GTM Challenge | Network-first GTM | Timeline unrealistic; case studies won't drive inbound Month 4-6 |

---

## Pulse 2 (2026-03-30 — Late AM)

| Agent | Topic | Key Findings |
|-------|-------|-------------|
| Technical Architecture | Simplification | Cut 4-layer self-improvement to Layer 1; Docker Compose + single PG |
| Vertical Focus | Horizontal vs vertical | Pick ONE vertical (professional services) before 7-sector push |
| Revenue Model | Pricing structure | MCP demoted to infrastructure; ETI tier aspirational; pilot fee range too wide |

---

## Pulse 3 (2026-03-30 — Midday)

| Agent | Topic | Key Findings |
|-------|-------|-------------|
| Landing Page Strategist | Hero + CTA | Lead with cost-claim / problem scale; lower first CTA (not €490 cold) |
| GTM Scalability | Network + inbound math | Personal network math unrealistic for 3-month pilots; SEO takes 12-18 months |
| Differentiation | Defensibility | Vertical depth + client relationships = moat, not technology |

---

## Pulse 4 (2026-03-30 — Late Day, 11:03 UTC)

| Agent | Topic | Key Findings |
|-------|-------|-------------|
| Managed Service Strategist | "Managed service" framing | Liability in first-touch hero; asset in "how we work"; replace with "AI employee" mental model |
| Tech Stack Strategist | MCP, Mastra, OVHcloud relevance | MCP is infrastructure detail, not marketing; 4-layer self-improvement is overkill for MVP; OVHcloud matters for IT/procurement, not DGs |
| Mistral Threat Strategist | Mistral entering managed agents | Not a 2026 threat (18-36 month timeline); real moat is operational excellence + vertical depth + client relationships, not AI research |

---

## Cumulative Resolved Decisions (as of Pulse 4)
...
| D8 | MCP marketing | Remove from all external materials; infrastructure detail only | Tech stack agent | 2026-03-30 |
| D9 | Self-improvement | Cut to Layer 1 for MVP | Technical architecture agent | 2026-03-30 |
| D10 | Vertical focus | ONE vertical, professional services first | Vertical focus agent | 2026-03-30 |
| D11 | "Managed service" | Move from headline to "how we work" section | Pulse 4 agent | 2026-03-30 |
| D12 | Mistral threat | 2027-2028 risk, not 2026; execution now is the priority | Pulse 4 agent | 2026-03-30 |
